...
final class MainWindowController: NSWindowController {
    ...
    private func buildUI() {
        ...
        let hint = NSTextField(wrappingLabelWithString: "Global panic hotkey: ⌃⌥⌘Esc  ·  space = play/stop, P = pause  ·  drag the bar to scrub")
        ...
        let stack = NSStackView(views: [timeLabel, positionSlider, markerStrip, frameLabel,
                                        statusLabel, infoLabel, transport, tools, hint])
